...
function VideoCard({video,insideCategory, setDeleteVideoResponse}) {
  ...
  const handleShow = async() => {setShow(true);
    ...
    // console.log(console.log(new Intl.DateTimeFormat("en-US",{year:"numeric",month:"2-digit",day:'2-digit',hour:"2-digit",minute:'2-digit',second:'2-digit'}))).format(date)
  ...
  return (
    <>
      ...
      <Card.Body>
        ...
        {insideCategory?null:<button className='text-danger btn' onClick={()=>removeVideo(video?.id)}><i class="fa-solid fa-trash-can fa-bounce"></i></button>}
        </div>
      </Card.Body>
    </Card>
